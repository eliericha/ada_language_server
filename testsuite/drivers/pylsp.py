...
class ALSClientServerConfig(ClientServerConfig):
    ...
    # Override the default client factory to our own which support recording a replay file
    ...
    def _get_devtools_command(self, server: str) -> list[str]:
        """We override this method to use our own lsp-devtools entry point if needed.
        ...
        TODO check if this is fixed upstream in this issue:
        https://github.com/swyddfa/lsp-devtools/issues/191
        """
