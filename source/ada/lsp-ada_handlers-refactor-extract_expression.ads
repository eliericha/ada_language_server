...
------------------------------------------------------------------------------
--
--  Implementation of the refactoring command to extract expression
...
package LSP.Ada_Handlers.Refactor.Extract_Expression is
...
private
   ...
   for Command'External_Tag use "als-refactor-extract-expression";

end LSP.Ada_Handlers.Refactor.Extract_Expression;
